# [Online Travel Agency System-SQL Injection-employee_edit.php]
...
**[Vulnerability Url]:** `http://10.142.221.111/Travel/admin/employee_edit.php?emp_id=65`    

**[Vulnerability Location]:** Travel/admin/employee_edit.php

**[Vulnerability Test]:**

1. payload:`emp_id=65%27%20and%20extractvalue(1,concat(0x7e,(select%20database()),0x7e))--+`

   ![](../../img/20230428154424.png)

   The database name was obtained from the above payload execution.

**[code analysis]:**

Travel/admin/employee_edit.php
...
The GET parameter `emp_id` is obtained without any filtering and spliced directly into the sql execution statement, and display the errors returned by the database execution back to the front-end page.
